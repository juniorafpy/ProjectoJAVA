...
public enum TipoMotorBD {
    POSTGRESQL ("postgresql", "org.postgresql.Driver","manejo_permisos_curso","postgres","envy","5432","localhost"),
    MYSQL ("mysql","com.mysql.jdbc.Driver","mvc","root","","3306","localhost");
